...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{Overview_Diagram.png}
	\caption{Architecture Diagram of the Publication Trend Tracking System}
	\label{fig: usecase}
\end{figure}
...
\begin{figure}[H]
	...
	\label{fig:class-generate-reports}reports
\end{figure}
%-------------------------------------------------
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{sequence_Manage-Users.png}
