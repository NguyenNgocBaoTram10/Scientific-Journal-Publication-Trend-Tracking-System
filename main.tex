...
>>>>>>> e51c35f32c4419cfd2a6d545f2644bb292107068
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{10cm}|}
		...
		Objective &
		Verify that the system validates registration fields and displays appropriate error messages when invalid information is entered.
		\\
		\hline
		...
		\begin{tabular}[t]{@{}l@{}}
			...
			2. Enter a Full Name containing only one word or numbers. \\
			3. Enter a username with fewer than 4 characters. \\
			4. Enter an invalid email format. \\
			5. Enter a password that does not meet the requirements. \\
		...
		Expected Result &
		\begin{tabular}[t]{@{}l@{}}
		The system rejects the registration request and displays \\
		the corresponding validation messages: \\
		• Please enter your full name \\
		(at least 2 words and letters only). \\
		• Username must be 4–20 characters long and contain \\
		...
		Actual Result &
		The correct validation messages are displayed
		\\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{10cm}|}
		...
		Objective &
		Verify that the system does not allow registration with a username that already exists in the database.
		\\
		\hline
		...
		\begin{tabular}[t]{@{}l@{}}
			1. Open Registration page.\\
			2. Enter all required information. \\
			3. Input an existing username (Group6). \\
		...
		Expected Result &
		\begin{tabular}[t]{@{}l@{}}
			The system rejects the registration request and message: \\
		...
		Actual Result &
		The correct validation message is displayed.
		\\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{10cm}|}
		...
		Objective &
		Verify system behavior when the search criteria are invalid or return no matching publications.
		\\
		\hline
		...
		Test Data &
		\begin{tabular}[t]{@{}l@{}}
		Scenario 1: Keyword: abcdeftopic123 \\
		Scenario 2: Keyword: machine learning \\
		Year from: 2025; Year to: 2022 
		\end{tabular}
		\\
		\hline
		...
		Scenario 2: \\
		1. Enter Keyword "machine learning" \\
		2. Select year range from 2025 to 2022\\
		3. Click Search
		\end{tabular}
		\\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{10cm}|}
		...
		Test Data &
		\begin{tabular}[t]{@{}l@{}}
			Scenario 1: Topic: abcdabcdeftopic \\
			Scenario 2: Topic: machine learning \\
			Year from 2025; Year to: 2022
		\end{tabular}
		\\
		\hline
		...
		\begin{tabular}[t]{@{}l@{}}
		Scenario 1: \\
		1. Enter non-existing topic "abcdeftopic123" \\
		2. Click Analyze \\
		Scenario 2: \\
	...
	\end{tabular}
		...
		Expected Result &
		No trend data is available. The system displays "No data available"
		\\
		\hline
		
		Actual Result &
		The "No data available" message is displayed correctly in all trend analysis sections.
		\\
		\hline
