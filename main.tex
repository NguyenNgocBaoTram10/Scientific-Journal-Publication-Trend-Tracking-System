...
\end{tabular}
	...
	\end{itemize}
	\subsection{Tools \& Infrastructure}
...
\begin{itemize}
	...
	\item Manage Users
	\item Configure Academic API Sources
	\item Synchronize Academic Data from External APIs
\end{itemize}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{10cm}|}
		...
		\begin{tabular}[t]{@{}l@{}}
			1. Open Registration page.\\
			2. Enter a Full Name containing only one word or numbers.6\\
		...
		Expected Result &
		The system rejects the registration request and displays the corresponding validation messages:
		\begin{itemize}
		\item Please enter your full name (at least 2 words and letters only).
		\item Username must be 4--20 characters long and contain only letters, numbers, or underscores.
		\item Invalid email address.
		\item Password must be at least 8 characters long and contain both letters and numbers.
		\end{itemize}
		\\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{10cm}|}
		...
		Expected Result &
		The system rejects the registration request and displays the message:
