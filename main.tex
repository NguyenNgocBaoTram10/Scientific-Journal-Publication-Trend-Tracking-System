...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{sreach.jpg}
	\caption{}
	\label{fig:erd}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{ptxh2.png}
	\caption{}
	\label{fig:erd}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{ptxh3.jpg}
	\caption{}
	\label{fig:erd}
\end{figure}
...
User opens \textit{Research Trend Analysis} $\rightarrow$ Enters a research topic and selects a time range $\rightarrow$ Clicks \textbf{Analyze} $\rightarrow$ Clicks \textbf{Generate Report} $\rightarrow$ Selects an export option (Preview \& Print / Save PDF, Download PDF, or Download HTML).
...
\begin{enumerate}
	...
	\item User clicks the \textbf{Generate Report} button.
...
\begin{figure}[H]
	...
	\label{fig:erd}
\end{figure}
>>>>>>> ae2d08aa93cec6c7f13690e91b433eccd8f11855
